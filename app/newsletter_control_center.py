...
def render_sidebar() -> str:
    ...
    page = st.sidebar.radio(
        ...
        index=[
            ...
            "Preview",
            "Files",
        ].index(st.session_state.get("active_page", "Overview") if st.session_state.get("active_page", "Overview") in ["Overview", "Portfolio", "Analytics", "Newsletter", "Preview", "Files", "History", "Factors", "Alerts"] else "Overview"),
    )
